...
class FoamSSG:
    ...
    def remove_link_reference_sections(self, content):
        ...
        # Pattern to match [//begin]: # "Autogenerated link references" ... [//end]: # "Autogenerated link references"
        # sections including all content between them
        pattern = r'\[//begin\]: # "Autogenerated link references"[\s\S]*?\[//end\]: # "Autogenerated link references"'
